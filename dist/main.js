...
const UiManager = () => {
  ...
  const initConsoleUI = () => {
    ...
    submitButton.className = tw`nanum-gothic-coding-bold tracking-wide px-3 py-1 text-center text-sm rounded-br-md border-solid border-2 border-gray-200 hover:bg-gray-200 hover:text-gray-800 hover:border-gray-800`; // Add TailwindCSS classes
