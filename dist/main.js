...
const executeCommand = command => {
  ...
  try {
    const {
      gridPosition,
      direction
    } = processPlacementCommand(command);
    ...
    return new Promise((resolve, reject) => {
      ...
      const handleValidInput = async input => {
        ...
        try {
          ...
          const placementSuccess = await humanPlayer.placeShip(shipType, gridPosition, direction);
          if (placementSuccess) {
