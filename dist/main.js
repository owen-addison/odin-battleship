...
const endGameInterface = winner => {
  ...
  promptContainer.className = tw`w-min h-60 bg-gray-200 p-2 rounded-md bg-opacity-30 backdrop-blur-md flex flex-col content-center justify-center`;
