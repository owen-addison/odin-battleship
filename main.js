...
const UiManager = () => {
  ...
  const initConsoleUI = () => {
    ...
    input.className = tw`pl-3 flex-1 rounded-bl-md border-transparent focus:border-solid focus:border-gray-200 focus:ring-2`; // Add TailwindCSS classes
